  ...
  return (
    ...
    <div className="container mx-auto p-8 bg-white shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
  <label className="block mb-2 font-medium text-gray-700">Hotel Picture</label>
  <div className="w-full max-w-[700px] overflow-x-auto">
    <div className="flex space-x-4 py-2 flex-nowrap">
      {/* Display uploaded images */}
      {images.length > 0 ? (
        images.map((image, index) => (
          <div key={index} className="relative min-w-[160px] w-40 h-40">
            <img
      ...
      />
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <div>
            <label className="block mb-2 font-medium text-gray-700">Hotel Tel-No *</label>
            <input
              type="tel"
              value={hotelTelNo}
          ...
          <div>
            <label className="block mb-2 font-medium text-gray-700">Hotel Capacity *</label>
            <input
              type="number"
              value={hotelCapacity}
