      ...
      >
        ...
        <div className="container mx-auto text-center py-24 relative z-10">
          ...
          <p className="text-2xl font-semibold text-gray-100 opacity-90 mb-6 leading-relaxed">
            Travel in comfort and style with our fleet of modern vehicles. From
            luxury cars to spacious vans, we have the perfect transport option
            for your journey.
          </p>
        </div>
      </section>
            ...
            filteredVehicles.map((vehicle, idx) => (
              <div key={idx} className="bg-white shadow-md rounded-lg">
                <img
                  src={
                    vehicle.photo
                      ? `http://localhost:3000/${vehicle.photo}`
                      : vehicle1
                  }
                ...
                <img
                  src={
                    selectedVehicle.photo
                      ? `http://localhost:3000/${selectedVehicle.photo}`
                      : vehicle1
                  }
        ...
        <div className="flex justify-center space-x-8">
          {["James Brown", "Sophia Lee", "Ahmed Khan"].map((name, idx) => (
            <div key={idx} className="text-center">
              ...
              <p className="text-sm">
                "The vehicles were clean, comfortable, and the drivers were
