      ...
      <header className="bg-orange-600 text-white py-6">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="flex space-x-6 text-lg">
            <a href="#" className="hover:text-gray-200">Package</a>
            <a href="#" className="hover:text-gray-200">Transport</a>
            <a href="#" className="hover:text-gray-200">Tour Guide</a>
            <a href="#" className="hover:text-gray-200">Hotels</a>
            <a href="#" className="hover:text-gray-200">Quotation</a>
