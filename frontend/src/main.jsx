...
import UserHotelDetailes from "./pages/User/Hotel/HotelDetailes.jsx";
...
const AppRoutes = () => (
  <Router>
    <Routes>
      ...
      <Route
        path="/adminTourPackageManagement"
        element={<AdminTourPackage />}
      />
      <Route
        path="/adminTourPackageManagement/addTour"
        element={<AddTourForm />}
      />
      <Route
        path="/adminTourPackageManagement/updateTour/:id"
        element={<UpdateTour />}
      />
      <Route
        path="/adminTourPackageManagement/deleteTour/:id"
        element={<DeleteTour />}
      />
      ...
      />
      <Route
        path="/adminTransportManagement/updatevehicle/:id"
      ...
      <Route path="/userHoteldetails/:id" element={<UserHotelDetailes />} />
      <Route
